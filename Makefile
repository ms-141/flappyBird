prog.tos: main.o asynch.o bird.o cond.o model.o score.o pipepair.o synch.o
	cc68x -g main.o asynch.o bird.o cond.o model.o score.o pipepair.o synch.o -o prog.tos
